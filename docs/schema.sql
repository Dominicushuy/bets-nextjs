-- ================================================================
-- File: recreate_all_tables.sql
-- Mục đích: Tạo lại tất cả các bảng trong dự án Game Cá Cược
...
CREATE TABLE profiles (
  ...
  email TEXT,  -- Thêm cột email để đồng bộ với auth.users
  phone TEXT,
  telegram_id TEXT,
...
CREATE TABLE bets (
  ...
  game_round_id UUID NOT NULL REFERENCES game_rounds(id),
...
CREATE TABLE promotions (
  ...
  min_level INTEGER NOT NULL DEFAULT 1 REFERENCES user_levels(level),
